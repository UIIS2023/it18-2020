...
public class DlgLine extends JDialog {
				...
				btnOk.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						try {
							...
							line = new Line(new Point(newFirstX, newFirstY), new Point(newSecondX, newSecondY),false, btnEdgeColor.getBackground());
							dispose();
						} catch (Exception ex) {
	...
	public void setBtnColor(JButton btnEdgeColor) {
